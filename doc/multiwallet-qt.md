...
Only requiring some minor changes is lunex.cpp.
...
Changes to lunex.cpp
----------------------
lunex.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
