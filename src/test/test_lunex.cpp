...
#define BOOST_TEST_MODULE Lunex Test Suite

#include "test_lunex.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_lunex_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
