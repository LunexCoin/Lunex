...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 1000;         // 1000 LUNEX
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 1521925200   ;// Enforcement starts at 03/26/2018 @ 1:00pm (GMT)
