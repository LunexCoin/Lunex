 ...
 *
 *   // network
 *   CLunexNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CLunexNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LunexNetwork
// //   -- signature requirements : Key1(User)
// class CLunexNetworkVariable : public CGovernanceObject
// {
// private:
