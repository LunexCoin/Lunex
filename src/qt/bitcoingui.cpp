    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Lunex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lunex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lunex: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Lunex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lunex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lunex Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lunex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lunex addresses"));
    ...
    openAction->setStatusTip(tr("Open a lunex: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/information"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lunex Core help message to get a list with possible Lunex Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Lunex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lunex network", "", count));
    } else {
...
{
    QString strTitle = tr("Lunex Core"); // default title
